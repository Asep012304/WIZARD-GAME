...
const lunnText = document.createElement("div");
lunnText.id = "lunn-text";
lunnText.textContent = "LunnVercel";
// Sembunyikan teks awalnya
lunnText.style.display = "none";
...
function startGame() {
    ...
    // Tampilkan teks saat game dimulai
    lunnText.style.display = "block";
    // Tambahkan ke dalam dokumen
    document.body.appendChild(lunnText);
    playermovment = true;
